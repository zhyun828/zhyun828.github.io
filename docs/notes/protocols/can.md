...
<figure markdown="span">
  <img src="../assets/can/can-frame-types.svg" alt="CAN five frame types" />
  <figcaption>图 1：CAN 协议的 5 种帧类型。根据 CAN 入门课件重绘。</figcaption>
</figure>
...
<figure markdown="span">
  <img src="../assets/can/can-frame.svg" alt="Classic CAN data frame" />
  <figcaption>图 2：经典 CAN 数据帧结构。根据 CAN 入门课件重绘。</figcaption>
</figure>
...
<figure markdown="span">
  <img src="../assets/can/can-bit-timing.svg" alt="CAN bit timing segments" />
  <figcaption>图 3：CAN 位时序。根据 CAN 入门课件位时序页重绘。</figcaption>
</figure>
...
<figure markdown="span">
  <img src="../assets/can/can-arbitration.svg" alt="CAN non destructive arbitration" />
  <figcaption>图 4：CAN 非破坏性仲裁示意。根据 CAN 入门课件重绘。</figcaption>
</figure>
...
<figure markdown="span">
  <img src="../assets/can/can-error-states.svg" alt="CAN error counters and states" />
  <figcaption>图 5：CAN 错误状态与 TEC/REC 计数器关系。</figcaption>
</figure>
...
<figure markdown="span">
  <img src="../assets/can/bxcan-structure.svg" alt="STM32 bxCAN basic structure" />
  <figcaption>图 6：STM32 bxCAN 基本结构。根据 CAN 入门课件重绘。</figcaption>
</figure>
